...
use App\Http\Controllers\Admin\BackgroundRemovalController;
...
use App\Http\Controllers\PrivateInstallmentController;
...
use App\Http\Middleware\AllowMobileCors;
...
if (config('private_installment.enabled', true)) {
    $privateInstallmentPath = trim((string) config('private_installment.path', 'private/cicilan-5-juta-30k'), '/');

    Route::get($privateInstallmentPath, [PrivateInstallmentController::class, 'show'])->name('private-installment.show');
    Route::post($privateInstallmentPath, [PrivateInstallmentController::class, 'store'])
        ->middleware('bot.guard')
        ->middleware('throttle:4,1')
        ->name('private-installment.store');
}
...
})->middleware([AllowMobileCors::class, 'throttle:vipayment-services'])->name('mobile.catalog');
...
})->middleware(AllowMobileCors::class)->name('mobile.payments.options');

Route::get('mobile/payments', function (Request $request, DuitkuService $duitku) {
    $headers = [
        'Access-Control-Allow-Origin' => '*',
        'Access-Control-Allow-Methods' => 'GET, OPTIONS',
        'Access-Control-Allow-Headers' => 'Content-Type, Accept, Origin',
...
})->middleware([AllowMobileCors::class, 'throttle:30,1'])->name('mobile.payments');
...
})->middleware(AllowMobileCors::class)->name('mobile.products.show.options');
...
})->middleware([AllowMobileCors::class, 'throttle:vipayment-services'])->name('mobile.products.show');
...
})->middleware(AllowMobileCors::class)->name('mobile.products.nickname.options');

Route::post('mobile/products/{product}/nickname', function (Request $request, string $product, VipaymentService $vipayment) {
    $headers = [
        'Access-Control-Allow-Origin' => '*',
        'Access-Control-Allow-Methods' => 'POST, OPTIONS',
        'Access-Control-Allow-Headers' => 'Content-Type, Accept, Origin',
    ...
    ->middleware([AllowMobileCors::class, 'throttle:vipayment-nickname'])
...
})->where('any', '.*')->middleware(AllowMobileCors::class)
    ->name('mobile.auth.options');

Route::post('mobile/auth/register', [MobileAuthController::class, 'register'])
    ->withoutMiddleware([ValidateCsrfToken::class])
    ->middleware([AllowMobileCors::class, 'throttle:6,1'])
    ->name('mobile.auth.register');
Route::post('mobile/auth/login', [MobileAuthController::class, 'login'])
    ->withoutMiddleware([ValidateCsrfToken::class])
    ->middleware([AllowMobileCors::class, 'throttle:6,1'])
    ->name('mobile.auth.login');
Route::post('mobile/auth/google', [MobileAuthController::class, 'google'])
    ->withoutMiddleware([ValidateCsrfToken::class])
    ->middleware([AllowMobileCors::class, 'throttle:10,1'])
    ->name('mobile.auth.google');
Route::post('mobile/auth/google/whatsapp', [MobileAuthController::class, 'googleWhatsapp'])
    ->withoutMiddleware([ValidateCsrfToken::class])
    ->middleware([AllowMobileCors::class, 'throttle:10,1'])
    ->name('mobile.auth.google.whatsapp');
Route::post('mobile/auth/whatsapp/verify', [MobileAuthController::class, 'verifyWhatsapp'])
    ->withoutMiddleware([ValidateCsrfToken::class])
    ->middleware([AllowMobileCors::class, 'throttle:6,1'])
    ->name('mobile.auth.whatsapp.verify');
Route::post('mobile/auth/whatsapp/resend', [MobileAuthController::class, 'resendWhatsapp'])
    ->withoutMiddleware([ValidateCsrfToken::class])
    ->middleware([AllowMobileCors::class, 'throttle:6,1'])
...
Route::post('mobile/checkout', [MobileCheckoutController::class, 'store'])
    ->withoutMiddleware([ValidateCsrfToken::class])
    ->middleware([AllowMobileCors::class, 'throttle:12,1'])
    ->name('mobile.checkout.store');
Route::get('mobile/checkout/{transaction}', [MobileCheckoutController::class, 'show'])
    ->middleware([AllowMobileCors::class, 'throttle:30,1'])
...
Route::get('mobile/account/history', [MobileAccountController::class, 'history'])
    ->middleware([AllowMobileCors::class, 'throttle:30,1'])
...
Route::redirect('hapus-akun', 'delete-account');
...
Route::middleware(['auth', 'admin.panel'])->group(function () {
    ...
    Route::get('dashboard/keuangan', FinanceController::class)->name('admin.finance.index');
    Route::get('dashboard/keuangan/export/csv', [FinanceController::class, 'exportCsv'])->name('admin.finance.export.csv');
    Route::post('dashboard/keuangan/biaya', [FinanceController::class, 'storeExpense'])->name('admin.finance.expenses.store');
    Route::delete('dashboard/keuangan/biaya/{manualExpense}', [FinanceController::class, 'destroyExpense'])->name('admin.finance.expenses.destroy');
    ...
    Route::get('dashboard/hapus-background', [BackgroundRemovalController::class, 'index'])->name('admin.background-remover.index');
    Route::post('dashboard/hapus-background', [BackgroundRemovalController::class, 'store'])->name('admin.background-remover.store');
    ...
    Route::post('dashboard/transaksi/{transaction}/manual-mark-paid', [TransactionMonitorController::class, 'markPaid'])->name('admin.transactions.manual.mark-paid');
